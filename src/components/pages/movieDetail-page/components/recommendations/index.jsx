...
export const Recommendations = ({ movieId }) => {
    ...
    return (
        <div className={styleRecommand.totalRecommand}>
            {
                getRecommand &&
                getRecommand.map((item) => {
                    return (
                        <div className={styleRecommand.imgRecommand}>
                            {
                                item.backdrop_path ?
                                    ...
                                    <div className={styleRecommand.noimg}>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="80" height="150" fill="currentColor" class="bi bi-image" viewBox="0 0 16 16">

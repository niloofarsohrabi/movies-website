...
import accountImage from '../../../../assets/img/account-image/accountImage.jpg'
                ...
                <div className="row">
                    <div className="col-lg-9">
                        <div className={styleBottomOfDetail.totalOfAccount}>
                            <div className={styleBottomOfDetail.title}>Top Billed Cast</div>
                            {
                    ...
                    <div className="col-lg-3">
                        ...
                        <div>{getDetailOfMovie.writer }</div>

...
export const MovieDetailPage = () => {
  const { id } = useParams();
  const detailOfMovieState = useSelector(
    (state) => state.detailOfMovieState.getDetailOfMovie
  );
  ...
  if (!receivedFullUrlImagesState || !detailOfMovieState) return <Loading />;
  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          backgroundImage: `url(${receivedFullUrlImagesState.base_url}${receivedFullUrlImagesState.backdrop_sizes[2]}${detailOfMovieState.backdrop_path})`,
        }}
      >
            ...
            <div className="row">
              ...
              <div className="col-lg-8">
                <div className={styleMovie.totalDesign}>
                  <div className={styleMovie.title}>
                    {detailOfMovieState.title}
                  </div>
                  ...
                  <div className={styleMovie.tagline}>
                    {detailOfMovieState.tagline}
                  </div>

...
export const MovieDetailPage = () => {
    ...
    //     if (localStorage["FavariteLocal"]) {
    //         console.log(JSON.parse(localStorage["FavariteLocal"]);
    //          setFavoriteList(JSON.parse(localStorage["FavariteLocal"]));
    //     }
    // }, [])
    useEffect(async () => {
    ...
    //     if(favoriteList.filter(favId => favId.toString() === id.toString() ).length === 0)
    //     return false;
    //     return true;
    // }
    const handleAddFav = (id) => {
            ...
            // if(!isInFavorites(id))
            // setFavoriteList(prevStete => prevStete.push(id));
                                ...
                                <div className={styleMovie.totalDesign}>
                                    ...
                                    <div className={styleMovie.buttongroup}>
                                        ...
                                        <div className={`${styleMovie.favarite} ${styleMovie.tooltip}`}
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="30" fill="currentColor" className="bi bi-heart" viewBox="0 0 16 16">
                                        ...
                                        <div className={`${styleMovie.save} ${styleMovie.tooltip}`}>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="30" fill="currentColor" className="bi bi-bookmark" viewBox="0 0 16 16">
                                        ...
                                        <div className={`${styleMovie.play} ${styleMovie.tooltip}`}>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="30" fill="currentColor" className="bi bi-play-fill" viewBox="0 0 16 16">
